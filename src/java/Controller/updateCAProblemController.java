...
public class updateCAProblemController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ProblemsUpByCABean pubcab = new ProblemsUpByCABean(id,formElements[0],full_str ,"UnSolved");

            
            MethodOperation mo = new MethodOperation();
            int b = mo.updateCAProblem(pubcab);
            if (b > 0) {
