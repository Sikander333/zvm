...
public class insertIntoCAProblemController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ProblemsUpByCABean pubcab = new ProblemsUpByCABean(formElements[0],full_str ,"UnSolved",date);

            
            MethodOperation mo = new MethodOperation();
            int b = mo.insertIntoCAProblem(pubcab);
            if (b > 0) {
