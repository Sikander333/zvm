...
public class updateStudentSolution extends HttpServlet {
            ...
            if (type.indexOf("multipart/form-data") >= 0) {
                ...
                List lis = null;
                  ...
                  try {
                      ...
                      Logger.getLogger(updateCAProblemController.class.getName()).log(Level.SEVERE, null, ex);
                  }
               ...
               StudentSolutionsBean stsb = new StudentSolutionsBean(id ,formElements[0] ,full_str ,"Updated");
            
            MethodDeclarations md = new MethodOperation();
            String IRAadharid =session.getAttribute("IRAadharidFromUpdateStudentSolutionJSP").toString();
            int b = md.updateStudentSolutionWithIRStatusAsUpdated(stsb ,IRAadharid);
            if (b > 0) {
                
                
                
                 response.sendRedirect("UploadedStudentSolution.jsp");
