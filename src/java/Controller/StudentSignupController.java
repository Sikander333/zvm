...
public class StudentSignupController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         if(request.getParameter("page").toString().equals("StudentSignup")){ 
                ...
                System.out.println("##########################################@@@@@@@@@@@@@@@@@###################    "+formElements[0]);       
                 ...
                 try {
                     ...
                     if(mo.userExist(formElements[1])){
                         response.sendRedirect("Studentsignup.jsp?value=3");
                         
                     }else{
                         StudentSignupBean stsub = new StudentSignupBean(formElements[1] ,formElements[2], formElements[3], formElements[4],formElements[5],formElements[6],formElements[7],formElements[8], formElements[9],formElements[10],formElements[11],formElements[12],full_str);
                         
                         
                         int b = mo.addStudent(stsub);
                         if (b > 0) {
                             
                             
                             
                             response.sendRedirect("StudentLogin.jsp?value=1");
                             // out.print("Inserted Successfully ........");
                         } else {
                             out.print("There is something wrong........");
                         }
                     }    } catch (ClassNotFoundException ex) {
                     Logger.getLogger(StudentSignupController.class.getName()).log(Level.SEVERE, null, ex);
