...
public class insertIntoIRProblemsController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         MethodDeclarations md = new MethodOperation();
           ProblemsUpByCABean pubcab = md.selectCAProblems(id);
           String IRAadharid = session.getAttribute("IRAadharidFromIRHome").toString();
            int b = md.insertIntoIRProblems(pubcab ,IRAadharid);
            int u = md.updateCAProblemsStatusInfinity(id ,IRAadharid);
