 ...
 * @author Lenovo
 */
public class Winner3SolutionsBean {
    ...
    public Winner3SolutionsBean() {
    }

    public Winner3SolutionsBean(String aadharid, String username, String college, String second_m, String third_m, String photo, int P_id, String iraadharid) {
