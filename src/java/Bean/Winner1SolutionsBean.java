 ...
 * @author Lenovo
 */
public class Winner1SolutionsBean {
    ...
    public Winner1SolutionsBean() {
    }

    public Winner1SolutionsBean(String aadharid, String username, String college, String second_m, String third_m, String photo, int P_id, String iraadharid) {
