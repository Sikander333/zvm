        ...
        <%
         response.setHeader("Cache-Control","no-cache,no-store,must-revalidate");
            if(session.getAttribute("aadharidFromStudentHome")!=null && session.getAttribute("passwordFromStudentHome")!=null){
               session.setAttribute("aadharidFromScoreBoardForStudents",session.getAttribute("aadharidFromStudentHome")); 
               session.setAttribute("passwordFromScoreBoardForStudents",session.getAttribute("passwordFromStudentHome"));
                           ...
                           <div class="card-body">
                              ...
                              <div class="row" style="margin-top:20px;">
                                  <div class="col-lg-1">
                                      ...
                                      %>
                                 <div style="cursor:not-allowed;"><a class="btn btn-info  " href="viewWinnerProblemForStudent.jsp?id=<%= pubcab.getP_id()%>" style="text-decoration:none; border: none;margin-left:20px;pointer-events: none;"><h3>View</h3></a></div>
                             </div>
                             <div class="col-lg-11">
                             ...
                             <div class="row">  
                                          ...
                                          <table style="font-size:25px;margin-top:30px;">
                                             ...
                                             <tr><td>Second Member</td><td><%=w3sb.getSecond_m()%></td></tr>
                                              ...
                                              <tr>
                                                  <%
                                               session.setAttribute("IRAadharidFromScoreBoardForStudentsFirstWinner",w3sb.getIraadharid());
                                                  %>
                                                  <td colspan="1"><a class="btn btn-info shadow-lg" href="viewFirstWinnerSolutionAsStudent.jsp?id=<%=w3sb.getP_id()%>&document=<%=stsb3.getF_Name()%>"  style="margin-top:20px; text-decoration:none;width:200px;height:65px;"><h2>View</h2></a></td>
                             ...
                             <div class="row">  
                                          ...
                                          <table style="font-size:25px;margin-top:30px;">
                                             ...
                                             <tr><td>Second Member</td><td><%=w2sb.getSecond_m()%></td></tr>
                                              ...
                                              <tr>
                                                  <%
                                               session.setAttribute("IRAadharidFromScoreBoardForStudentsSecondWinner",w2sb.getIraadharid());
                                                  %>
                                                  <td colspan="1"><a class="btn btn-info shadow-lg" href="viewSecondWinnerSolutionAsStudent.jsp?id=<%= w2sb.getP_id()%>&document=<%=stsb2.getF_Name()%>"  style="margin-top:20px; text-decoration:none;width:200px;height:65px;"><h2>View</h2></a></td>
                             ...
                             <div class="row">  
                                          ...
                                          <table style="font-size:25px;margin-top:30px;">
                                             ...
                                             <tr><td>Second Member</td><td><%=w1sb.getSecond_m()%></td></tr>
                                              ...
                                              <tr>
                                                  <%
                                                session.setAttribute("IRAadharidFromScoreBoardForStudentsThirdWinner",w1sb.getIraadharid());
                                                  %>
                                                  <td colspan="1"><a class="btn btn-info shadow-lg" href="viewThirdWinnerSolutionAsStudent.jsp?id=<%=w1sb.getP_id()%>&document=<%=stsb1.getF_Name()%>"  style="margin-top:20px; text-decoration:none;width:200px;height:65px;"><h2>View</h2></a></td>
