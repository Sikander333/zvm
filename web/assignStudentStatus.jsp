  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js"></script>
    ...
    <body style="background-color:#88bdbc;">
         ...
         <%
            ...
            if(session.getAttribute("IRAadharidFromNewStudentRequest")!=null && session.getAttribute("passwordFromNewStudentRequest")!=null){
        ...
        <div align="center">
            <div class="card shadow-lg" style = "margin-top : 350px;width:60%;height:70%;padding:20px;border:none;" align="left">	
                                ...
                                <form method="post" action="assignStudentStatusController">
                                     <input type="hidden" name="page" value="assignStudentStatus">  
...
<%
String IRAadharid = session.getAttribute("IRAadharidFromNewStudentRequest").toString();
session.setAttribute("IRAadharidFromAssignStudentStatus", IRAadharid);
