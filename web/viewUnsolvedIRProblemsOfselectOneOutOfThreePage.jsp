  ...
  width:60%;  
    ...
    <body>
        ...
        <%
           ...
           if(session.getAttribute("AadharidFromSelectOneOutOfThree")!=null && session.getAttribute("passwordFromSelectOneOutOfThree")!=null){
    ...
    String IRAadharid= mo.selectStudentTableReferenceId(aadharid);
