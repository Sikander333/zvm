...
%>
                         ...
                         <div class="card-body "  >
                              ...
                              <table align="left" width="60%">
                                    <tr><td ><img src="image_ddp/<%=sasb.getF_Name()%>" class="rounded-circle " style="height:200px;width:200px;margin-top:0px;" ></td><td ><div align="center" class="font_size"><%=sasb.getUsername()%><br><%=sasb.getCollege()%></div> </td></tr>
