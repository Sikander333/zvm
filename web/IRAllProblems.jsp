        ...
        <%
         response.setHeader("Cache-Control","no-cache,no-store,must-revalidate");
            if(session.getAttribute("aadharidFromStudentHome")!=null && session.getAttribute("passwordFromStudentHome")!=null){
              session.setAttribute("aadharidFromIRAllProblems",session.getAttribute("aadharidFromStudentHome"));
              session.setAttribute("passwordFromIRAllProblems",session.getAttribute("passwordFromStudentHome"));
                ...
                <div class="col-lg-12"  style="height:899px;background-color: #88bdbc;overflow-y:scroll;padding:0px;">
                     ...
                     <div class="uploaded_problems_sticky" style="z-index:1;margin-top:40px;margin-bottom:40px;width:100%;" >
                         ...
                         <div class="card shadow-lg" style="background-color:rgba(23,67,88,0.5);color:white;padding:40px;"  >
                                               ...
                                               <h2 align="center"><i>All Problems of Institute Representative</i></h2>
                      ...
                      <% 
                        ...
                        String IRAadharid = session.getAttribute("IRAadharidFromStudentHome").toString();
                             session.setAttribute("IRAadharidFromIRAllProblems",IRAadharid);
                  ...
                  <div align="center">                       
                       ...
                       <div class="card shadow-lg outermost_card_padding" style=";margin-bottom:70px;background-color: #112d32;">
                           ...
                           <div class="card-body">
                               ...
                               <p align="left"><%= irpb.getP_des()%></p>
                               
                               
                              <hr>
                                   <div class="row" style="margin-left:10px;"><h4>Status</h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<h3><span class="badge badge-secondary"><%=irpb.getStatus1()%></span></h3></div>
                               <div class="row" style="margin-left:10px;"><h4>Uploaded&nbsp;:&nbsp;<%=irpb.getPdate()%></h4></div>
                               ...
                               <div class="card-footer" >
                                            ...
                                            <div class="row" >
                                               <div  class="col-12"><a class="btn btn-info btn-block " href="viewAllIRProblems.jsp?id=<%= irpb.getP_id()%>" style="text-decoration:none; border: none;">View</a></div> 
                      ...
                      <div align="center">  
                           ...
                           <div class="card-body">
                               ...
                               <span ><i class="fa fa-folder-open fa-10x " style="color:lightgrey;margin-top:60px;"></i></span>
                                <h1 align="center" style="color:lightgrey;">  None of the problems has been forwaded by the Institute Representative    </h1>     
                           </div>
