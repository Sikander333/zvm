  ...
  width:60%;  
    ...
    <body>
        ...
        <%
           ...
           if(session.getAttribute("IRAadharidFromVerifiedSolutions")!=null && session.getAttribute("passwordFromVerifiedSolutions")!=null){
    ...
    String IRAadharid = session.getAttribute("IRAadharidFromVerifiedSolutions").toString();
