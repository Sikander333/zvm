...
<html lang="en-US">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js"></script>
   ...
   window.location.assign("CASignup.jsp?value=0");
   ...
   %>
    ...
    <div class = "card" style = "margin-top : 170px;width:70%;" align="left">
	  ...
	  <h1 class = text-center style = "font-family : 'Monotype Corsiva' ; color : #112d32">SignUp</h1>			
                                ...
                                <form method="post" action="CASignupController?page=CASignup" enctype="multipart/form-data">
 <input type="hidden" name="page" value="CARegister"> 
<div class="form-group col-xs-4 padding:20px;" >
...
<br>
<div class="row" >
<input type="submit" name="save"  value="Submit" class = "btn btn-success" style="width:20%;font-size:30px;"   />
</div>
</div>
</form>
</div> 
