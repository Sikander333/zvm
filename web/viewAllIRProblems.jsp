  ...
  width:60%;  
    ...
    <body>
        ...
        response.setHeader("Cache-Control","no-cache,no-store,must-revalidate");
            if(session.getAttribute("aadharidFromIRAllProblems")!=null && session.getAttribute("passwordFromIRAllProblems")!=null){
    ...
    String IRAadharid= session.getAttribute("IRAadharidFromIRAllProblems").toString();
    IRProblemsBean irpb=mo.selectIRProblems(id,IRAadharid);
    if(irpb!=null){   //To check thet the row coming in student proxy object from database is not null
        String str=irpb.getF_Name();
