  ...
  <style>
    ...
    <body >
        <%
           ...
           session.setAttribute("aadharidFromNewIRRequest",session.getAttribute("aadharidFromcollectorHome"));
           session.setAttribute("passwordFromNewIRRequest",session.getAttribute("passwordFromcollectorHome"));
        %>
                ...
                <div class="col-lg-12"  style="height:899px;background-color: #88bdbc;overflow-y:scroll;padding:0px;">
                     ...
                     <div class="uploaded_problems_sticky" style="z-index:1;margin-top:30px;margin-bottom:30px;width:100%;" >
                         ...
                         <div class="card shadow-lg" style="background-color:rgba(23,67,88,0.5);color:white;padding:40px;"  >
                                               ...
                                               <h2 align="center"><i>New Institute Representative Requests</i></h2>
                           ...
                           <div class="card-body">
                             ...
                             <div class="row">  
                                 <div class="col-lg-4">
                                      ...
                                      <img src="image_ddp/<%=rs.getString(11)%>" class="rounded-circle " style="height:400px;width:400px;margin-top:25px;" > 
                                   ...
                                   <div class="col-lg-5">
                                          <table style="font-size:25px;margin-top:30px;">
                                              ...
                                              <tr><td>emailadd</td><td>:&nbsp</td><td><%=rs.getString(4) %></td></tr>
                                              <tr><td>contact no</td><td>:&nbsp</td><td><%=rs.getString(5) %></td></tr>
                                              <tr><td>college</td><td>:&nbsp</td><td><%=rs.getString(6) %></td></tr>
                                              <tr><td>address</td><td>:&nbsp</td><td><%=rs.getString(7) %></td></tr>
                                              <tr><td>city</td><td>:&nbsp</td><td><%=rs.getString(8) %></td></tr>
                                              <tr><td>state</td><td>:&nbsp</td><td><%=rs.getString(9) %></td></tr>
                                              
                                          </table>
                                      </div>  
                                          <div class="col-lg-3">
                                              <a style = "font-size : 40px;padding:20px;margin-top:150px;" class="btn btn-dark shadow-lg" href="assignIRStatus.jsp?id=<%= rs.getString(1) %>">Assign Status</a>
