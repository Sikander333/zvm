    ...
    <body>
          ...
          <%
           ...
           if(session.getAttribute("IRAadharidFromIRHome")!=null && session.getAttribute("passwordFromIRHome")!=null){
               session.setAttribute("IRAadharidFromScoreBoardForIR",session.getAttribute("IRAadharidFromIRHome"));
               session.setAttribute("passwordFromScoreBoardForIR",session.getAttribute("passwordFromIRHome"));
                           ...
                           <div class="card-body">
                              ...
                              <div class="row" style="margin-top:20px;">
                                  <div class="col-lg-1">
                                      ...
                                      %>
                                 <a class="btn btn-info  " href="viewWinnerProblemForIR.jsp?id=<%= pubcab.getP_id()%>&document=<%=pubcab.getF_Name()%>" style="text-decoration:none; border: none;margin-left:20px;"><h3>View</h3></a>
                             </div>
                             <div class="col-lg-11">
                             ...
                             <div class="row">  
                                          ...
                                          <table style="font-size:25px;margin-top:30px;">
                                             ...
                                             <tr><td>Second Member</td><td><%=w3sb.getSecond_m()%></td></tr>
                                              ...
                                              <tr>
                                                  <%
                                               session.setAttribute("IRAadharidFromScoreBoardForIRFirstWinner",w3sb.getIraadharid());
                                                  %>
                                                  <td colspan="1"><a class="btn btn-info shadow-lg" href="viewFirstWinnerSolutionAsIR.jsp?id=<%=w3sb.getP_id()%>&document=<%=stsb3.getF_Name()%>"  style="margin-top:20px; text-decoration:none;width:200px;height:65px;"><h2>View</h2></a></td>
                             ...
                             <div class="row">  
                                          ...
                                          <table style="font-size:25px;margin-top:30px;">
                                             ...
                                             <tr><td>Second Member</td><td><%=w2sb.getSecond_m()%></td></tr>
                                              ...
                                              <tr>
                                                  <%
                                               session.setAttribute("IRAadharidFromScoreBoardForIRSecondWinner",w2sb.getIraadharid());
                                                  %>
                                                  <td colspan="1"><a class="btn btn-info shadow-lg" href="viewSecondWinnerSolutionAsIR.jsp?id=<%= w2sb.getP_id()%>&document=<%=stsb2.getF_Name()%>"  style="margin-top:20px; text-decoration:none;width:200px;height:65px;"><h2>View</h2></a></td>
                             ...
                             <div class="row">  
                                          ...
                                          <table style="font-size:25px;margin-top:30px;">
                                             ...
                                             <tr><td>Second Member</td><td><%=w1sb.getSecond_m()%></td></tr>
                                              ...
                                              <tr>
                                                  <%
                                                session.setAttribute("IRAadharidFromScoreBoardForIRThirdWinner",w1sb.getIraadharid());
                                                  %>
                                                  <td colspan="1"><a class="btn btn-info shadow-lg" href="viewThirdWinnerSolutionAsIR.jsp?id=<%=w1sb.getP_id()%>&document=<%=stsb1.getF_Name()%>"  style="margin-top:20px; text-decoration:none;width:200px;height:65px;"><h2>View</h2></a></td>
