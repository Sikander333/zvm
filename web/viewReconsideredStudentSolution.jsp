...
div.card_width{
  width:60%;  
    ...
    <body>
           ...
           if(session.getAttribute("IRAadharidFromReviewedSolutions")!=null && session.getAttribute("passwordFromReviewedSolutions")!=null){
    ...
    String IRAadharid = session.getAttribute("IRAadharidFromReviewedSolutions").toString();
