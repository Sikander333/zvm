                ...
                <div class="col-lg-12"  style="height:899px;background-color: #88bdbc;overflow-y:scroll;padding:0px;">
                     ...
                     <div class="uploaded_problems_sticky" style="z-index:1;margin-top:40px;margin-bottom:40px;width:100%;" >
                         ...
                         <div class="card shadow-lg" style="background-color:rgba(23,67,88,0.5);color:white;padding:40px;"  >
                                               ...
                                               <h2 align="center"><i>All Students</i></h2>
                     ...
                     MethodDeclarations md=new MethodOperation();
                       ...
                       List lisacapwirt = md.selectAllStudents();
                        if (lisacapwirt != null) {

                            ListIterator lit = lisacapwirt.listIterator();
                            while (lit.hasNext()) {
                                ShowAllStudentsBean sasb = (ShowAllStudentsBean) lit.next();
...
%>
                         ...
                         <div class="card-body "  >
                              ...
                              <table align="left" width="60%">
                                    <tr><td ><img src="image_ddp/<%=sasb.getF_Name()%>" class="rounded-circle " style="height:200px;width:200px;margin-top:0px;" ></td><td ><div align="center"  class="font_size"><%=sasb.getUsername()%><br><%=sasb.getCollege()%></divv> </td></tr>
                                    
                                </table>   
                                    
                              <div class="card collapsible_button1 rounded-square" style="width:10%;cursor:pointer;max-height: 100px;margin-top:70px;"  data-toggle="collapse" data-target="#IndividualStudent<%=sasb.getAadharid()%>" ></div>   
                                        ...
                                        <div class="collapse" id="IndividualStudent<%=sasb.getAadharid()%>">  
                           <div class="card card_width" align="center" style="background-color:#f3f8f8;padding-left:20px;padding-right:20px;font-size:20px;min-height:450px;margin-bottom:40px;border:none;" >
                           ...
                           <div class="card-body">
                             ...
                             <div class="row">  
                                          ...
                                          <table style="margin-top:0px;width:90%" align="center" class="table_fontsize">
                                              ...
                                              <tr><td><hr>Second Member</td><td><hr><%=sasb.getSecond_m()%></td></tr>
                                              <tr><td>Third Member</td><td><%=sasb.getThird_m()%></td></tr>
                                              <tr><td>Institute Representative</td><td><%=md.getUserName(sasb.getReferenceid())%></td></tr>
                                              <tr><td>Email Address</td><td><%=sasb.getEmailadd()%></td></tr> 
                                              <tr><td>Contact No.</td><td><%=sasb.getContactno()%></td></tr>
                                              <tr><td>Address</td><td><%=sasb.getAddress()%></td></tr>
                                              <tr><td>City</td><td><%=sasb.getCity()%></td></tr>
                                              <tr><td>State</td><td><%=sasb.getState()%></td></tr>
