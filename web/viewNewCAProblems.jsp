  ...
  width:60%;  
    ...
    <body>
          ...
          <%
           ...
           if(session.getAttribute("IRAadharidFromCAAllProblems")!=null && session.getAttribute("passwordFromCAAllProblems")!=null){
    ...
    ProblemsUpByCABean pubcab=mo.selectCAProblems(id);
    if(pubcab!=null){   //To check thet the row coming in student proxy object from database is not null
        String str=pubcab.getF_Name();
