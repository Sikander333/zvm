...
div.card_width{
    ...
    <body>
           ...
           if(session.getAttribute("aadharidFromScoreBoardForStudents")!=null && session.getAttribute("passwordFromScoreBoardForStudents")!=null){
    ...
    String IRAadharid = session.getAttribute("IRAadharidFromScoreBoardForStudents").toString();
