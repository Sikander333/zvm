...
<jsp:include page="title.jsp" />
    ...
    <body>
        ...
        response.setHeader("Cache-Control","no-cache,no-store,must-revalidate");
            if(session.getAttribute("aadharidFromUploadedStudentSolution")!=null && session.getAttribute("passwordFromUploadedStudentSolution")!=null){
        %>
          ...
          <%
           ...
           String aadharid = session.getAttribute("aadharidFromUploadedStudentSolution").toString();
           
           session.setAttribute("aadharidFromStudentSolution",aadharid);
           String IRAadharid = session.getAttribute("IRAadharidFromUploadedStudentSolution").toString();
           
           session.setAttribute("IRAadharidFromUpdateStudentSolutionJSP",IRAadharid);
          %>
            ...
            <div align="center" >
                ...
                <div  class="card_width">
                         ...
                         <div class="card-title" style="padding:20px;">
                             <h1 style="color:darkgray;">Update Solution for Problem <%=id%></h1>
                            </div>
                         
                         <div class="card-body" style="background-color:#f3f8f8;">
                             
                                 
                                 <form action="updateStudentSolution" method="post" enctype="multipart/form-data">
                                        <div class="row" >
