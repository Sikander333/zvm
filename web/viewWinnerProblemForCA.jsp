...
div.card_width{
    ...
    <body>
           ...
           if(session.getAttribute("aadharidFromScoreBoardForCA")!=null && session.getAttribute("passwordFromScoreBoardForCA")!=null){
    ...
    String IRAadharid = session.getAttribute("IRAadharidFromScoreBoardForCA").toString();
