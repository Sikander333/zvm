                ...
                <div class="col-lg-12"  style="height:899px;background-color: #88bdbc;overflow-y:scroll;padding:0px;">
                     ...
                     <div class="uploaded_problems_sticky" style="z-index:1;margin-top:40px;margin-bottom:40px;width:100%;" >
                         ...
                         <div class="card shadow-lg" style="background-color:rgba(23,67,88,0.5);color:white;padding:40px;"  >
                                               ...
                                               <h2 align="center"><i>Reviewed Solutions</i></h2>
                    ...
                    MethodDeclarations md = new MethodOperation();
                      ...
                      session.setAttribute("IRAadharidFromReviewedSolutions",IRAadharid);
                      session.setAttribute("passwordFromReviewedSolutions",session.getAttribute("passwordFromIRHome"));
                     ...
                     if (li != null) {
                           ...
                           ListIterator lit = li.listIterator();
                            while (lit.hasNext()) {
                               ...
                               if(stsb.getIRStatus().equals("Updated")){     
                                 ...
                                 <div class=" col-lg-4 ">
                                   ...
                                   <div class="col-lg-5 ">
                                          ...
                                          <table style="font-size:25px;margin-top:30px;">
                                              ...
                                              <tr class="view_button_table"><td><a class="btn btn-info " href="viewReconsideredStudentSolution.jsp?id=<%= stsb.getP_id()%>"  style="text-decoration:none;width:200px;"><h2>View</h2></a></td></tr> 
                                          </table>
                                              
                                      </div>  
                                          <div class="col-lg-3">
                                              
                                                  <div class="view_button_div" ><a style = "font-size : 40px;padding:20px;margin-top:130px;width:250px;height:100px;" class="btn btn-info shadow-lg" href="viewReconsideredStudentSolution.jsp?id=<%= stsb.getP_id()%>">View</a></div>
                                              
                                              <a style = "font-size : 40px;padding:20px;margin-top:50px;width:250px;height:100px;" class="btn btn-dark shadow-lg" href="acceptReviewedStudentSolutionsController?id=<%= stsb.getP_id() %>">Accept</a>
                    ...
                    <%
                           ...
                           <div class="card-body">
                               ...
                               <span ><i class="fa fa-folder-open fa-10x " style="color:lightgrey;margin-top:60px;"></i></span>
                                <h1 align="center" style="color:lightgrey;">  No Reviewed Solution found !!.    </h1>     
                           </div>
