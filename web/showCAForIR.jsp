                ...
                <div class="col-lg-12"  style="height:899px;background-color: #88bdbc;overflow-y:scroll;padding:0px;">
                     ...
                     <div class="uploaded_problems_sticky" style="z-index:1;margin-top:40px;margin-bottom:40px;width:100%;" >
                         ...
                         <div class="card shadow-lg" style="background-color:rgba(23,67,88,0.5);color:white;padding:40px;"  >
                                               ...
                                               <h2 align="center"><i>Collector Profile</i></h2>
...
%>
                         ...
                         <div class="card-body "  >
                              ...
                              <table align="left" width="60%">
                                    <tr><td ><img src="image_ddp/<%=rs.getString("file")%>" class="rounded-circle img_size" style="margin-top:0px;" ></td><td ><div align="center" class="font_size" ><%=rs.getString("username")%><br><%=rs.getString("district")%></div> </td></tr>
                                    
                                </table>   
                                    
                              <div class="card collapsible_button1 rounded-square" style="width:10%;cursor:pointer;max-height: 100px;margin-top:70px;"  data-toggle="collapse" data-target="#IndividualCA<%=rs.getString("aadharid")%>" ></div>   
                                        ...
                                        <div class="collapse" id="IndividualCA<%=rs.getString("aadharid")%>">  
                           <div class="card card_width" align="center" style="background-color:#f3f8f8;padding-left:20px;padding-right:20px;font-size:20px;min-height:400px;margin-bottom:40px;border:none;" >
                           ...
                           <div class="card-body">
                             ...
                             <div class="row">  
                                          ...
                                          <table style="margin-top:0px;width:90%" align="center" class="table_fontsize">
                                              ...
                                              <tr><td><hr>Email Address</td><td><hr><%=rs.getString("emailadd")%></td></tr> 
                      ...
                      <div align="center">  
                           ...
                           <div class="card-body">
                               ...
                               <span ><i class="fa fa-folder-open fa-10x " style="color:lightgrey;margin-top:60px;"></i></span>
                                <h1 align="center" style="color:lightgrey;"> Collector Assistant Not found !!  </h1>     
                           </div>
